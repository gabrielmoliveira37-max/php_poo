...
echo "O valor do desconto de $joao->nome é R$ $joao->descontos. <br>";
echo "O valor do desconto de $maria->nome é R$ $maria->descontos. <br>";
echo "O valor do desconto de $jose->nome é R$ $jose->descontos. <br>";